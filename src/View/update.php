...
Quantidade Membros <input type="text" name="endereco" value="<?php echo $registrosfeitos['quantidade_membros']; ?>" />

<input type = "hidden" name="id" value="<?php echo $registrosfeitos['id']; ?>" />
<input class="w3-button w3-green"  type = "submit" name="acao" value="Editar" />
